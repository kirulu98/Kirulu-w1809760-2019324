<section class="get-started-area section--padding " id="for-businesses">
    <div class="container">

        <div class="row pt-2px">
            <div class="col-lg-4 responsive-column-half">
                <div class="media media-card align-items-center hover-s">
                    ...
                    <div class="media-body">
                        <h5 class="pb-2"><a href="">Private Q&A</a></h5>
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="media media-card align-items-center hover-s">
                    ...
                    <div class="media-body">
                        <h5 class="pb-2"><a href="">Talent solutions</a></h5>
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="media media-card align-items-center hover-s">
                    ...
                    <div class="media-body">
                        <h5 class="pb-2"><a href="">Public Solutions</a></h5>
